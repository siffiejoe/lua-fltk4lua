...
namespace {
  ...
  int check_browser_index( lua_State* L ) {
  ...
  int check_browser_newindex( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    size_t n = 0;
    char const* key = luaL_checklstring( L, 2, &n );
    F4L_TRY {
  ...
  int new_check_browser( lua_State* L ) {
    F4L_TRY {
  ...
  int check_browser_add( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
  ...
  int check_browser_check_all( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    F4L_TRY {
      b->check_all();
    } F4L_CATCH( L );
  ...
  int check_browser_check_none( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    F4L_TRY {
      b->check_none();
    } F4L_CATCH( L );
  ...
  int check_browser_checked( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
  ...
  int check_browser_clear( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    F4L_TRY {
      b->clear();
    } F4L_CATCH( L );
  ...
  int check_browser_remove( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    int i = moon_checkint( L, 2, 1, INT_MAX );
    F4L_TRY {
      int nitems = b->nitems();
  ...
  int check_browser_set_checked( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    int i = moon_checkint( L, 2, 1, INT_MAX );
    F4L_TRY {
      int nitems = b->nitems();
  ...
  int check_browser_text( lua_State* L ) {
    Fl_Check_Browser* b = check_check_browser( L, 1 );
    int i = moon_checkint( L, 2, 1, INT_MAX );
    F4L_TRY {
      int nitems = b->nitems();
...
MOON_LOCAL void f4l_check_browser_setup( lua_State* L ) {
  ...
  moon_defcast( L, F4L_CHECK_BROWSER_NAME, F4L_BROWSERX_NAME,
                f4l_cast< Fl_Check_Browser, Fl_Browser_ > );
#if 0
  moon_defcast( L, F4L_CHECK_BROWSER_NAME, F4L_GROUP_NAME,
                f4l_cast< Fl_Check_Browser, Fl_Group > );
#endif
  moon_defcast( L, F4L_CHECK_BROWSER_NAME, F4L_WIDGET_NAME,
                f4l_cast< Fl_Check_Browser, Fl_Widget > );
