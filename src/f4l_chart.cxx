...
#define TYPE_LIST( _ ) \
  ...
  int chart_newindex( lua_State* L ) {
    Fl_Chart* c = check_chart( L, 1 );
    size_t n = 0;
    char const* key = luaL_checklstring( L, 2, &n );
    F4L_TRY {
